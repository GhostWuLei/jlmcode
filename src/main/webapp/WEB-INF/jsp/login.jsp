...
<div class="LoginWrapbg ">
    ...
    <div class="copyright">
        <div class="center">Copyright &copy; 2019-2099  <a href="<fmt:message key="app.name.url" bundle="${commonBundle}"/>" target="_blank" ><fmt:message key="app.name" bundle="${commonBundle}"/></a></div>
    </div>
</div>
