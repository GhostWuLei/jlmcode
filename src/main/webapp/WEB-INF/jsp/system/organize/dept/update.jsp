	...
	<form method="post" action="dept/update.do" onsubmit="return validateSubmitForm(this)">
		  ...
		  <div  style="margin-left: 10px;margin-top: 10px;margin-bottom: 5px;">
				...
				<%--<shiro:hasPermission name="dept:delete">--%>
					<c:url var="url_deldept" value="dept/del.do" >
					...
					<a class="btn btn-danger" target="ajaxTodo"  href="${url_deldept }" title="您确定删除部门<font color='red'>[${requestScope.dept.deptName }]</font>吗？如果此部门有下级部门，或者此部门有用户，将无法删除！"><i class="boot_icon-remove-sign boot_icon-white"></i> 删除</a>
				<%--</shiro:hasPermission>--%>
