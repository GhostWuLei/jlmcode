        ...
        <div class="search-toolbar"  >
			<span style="float:left;">
                ...
                <a class="easyui-linkbutton"  icon="icon-add"	plain="true"
                       title="添加系统菜单操作"	 href="menu/action/addPage.do?menuId={#${param.rel}_menuId}&rel=${param.rel}" target="dialog" width="800" height="400" rel="${param.rel}_add" warn="请先点击左侧菜单,选择操作所属菜单!">添加</a>
